...
public class InvitationPage {
    ...
    public void show(DatabaseHelper databaseHelper,Stage primaryStage) {
        ...
        Label TimeLabel = new Label("5 Minutes to us code");
        TimeLabel.setStyle("-fx-font-size: 14px; -fx-font-style: italic;");
        ...
        layout.getChildren().addAll(userLabel, showCodeButton, inviteCodeLabel, TimeLabel);
	    Scene inviteScene = new Scene(layout, 800, 400);
